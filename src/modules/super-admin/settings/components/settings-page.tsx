        ...
        <div className="grid grid-cols-2 gap-5">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <Button onClick={() => showToast("✅ Platform settings saved")}>Save Changes</Button>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <Button onClick={() => showToast("✅ Security settings saved")}>Save Changes</Button>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <Button onClick={() => showToast("✅ Notification settings saved")}>Save Changes</Button>
            </CardContent>
          </Card>
