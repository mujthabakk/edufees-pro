...
export function InvoicesPage() {
  ...
  const handleGenerate = () => {
    ...
    const newInv: Invoice = {
      ...
      studentName: genForm.student.trim(),
      class: genForm.class,
      amount: Number(genForm.amount),
      date: today,
      dueDate: genForm.dueDate,
      feeType: genForm.feeType,
    ...
    showToast(`✅ Invoice ${newInv.invoiceNo} generated for ${newInv.studentName}`);
        ...
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
          <Card className="w-[380px] p-6 space-y-4">
            ...
            <div className="flex gap-2 justify-end">
              ...
              <Button onClick={() => { setInvoices(p => p.filter(i => i.id !== deleteInv.id)); showToast(`🗑️ ${deleteInv.invoiceNo} deleted`); setDeleteInv(null); }} className="bg-red-600 hover:bg-red-700 text-white">Delete</Button>
            </div>
          </Card>
        </div>
      )}
